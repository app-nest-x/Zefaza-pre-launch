...
const CustomSection = () => {
  return (
    <motion.div
      className="hidden md:flex min-h-screen bg-gray-50 flex-col items-center justify-center p-8 relative overflow-hidden"
    ...
    >
      ...
      <div className="relative max-w-7xl w-full flex justify-between items-center">
        {/* Left Side - Why Sell on Zefaza */}
        <motion.div
          className="relative z-20 flex flex-col space-y-8"
          variants={itemVariants}
        >
          <motion.div
            className="bg-white px-6 py-3 rounded-xl shadow-sm border border-gray-100 text-center"
            variants={itemVariants}
          >
        ...
        {/* Right Side - Built for Sellers Like You */}
        <motion.div
          className="relative z-20 flex flex-col space-y-8"
          variants={itemVariants}
        >
      ...
      {/* Enhanced connecting lines from center to sides */}
      <motion.div
