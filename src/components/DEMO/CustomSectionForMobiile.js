...
export default function CustomSectionMobile() {
  return <motion.section className="sm:hidden px-6 py-16 bg-white space-y-16" initial="hidden" whileInView="visible" viewport={{
    once: true,
    amount: 0.1
  }} variants={{
    visible: {
      ...
      <motion.div className="space-y-8" variants={itemVariants}>
        ...
        return <motion.div key={i} className="bg-gray-50 rounded-2xl p-6 border border-gray-100 hover:shadow-md transition-all duration-300" variants={itemVariants} whileHover={{
          y: -2
        }}>
      ...
      <motion.div className="space-y-8" variants={itemVariants}>
        ...
        <div className="space-y-6">
          ...
          return <motion.div key={index} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all duration-300" variants={itemVariants} whileHover={{
            y: -2
          }}>
                <div className="flex items-start space-x-4">
      ...
      <motion.div className="space-y-8" variants={itemVariants}>
        ...
        <div className="space-y-6">
          {socialProof.map((item, index) => <motion.div key={index} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md transition-all duration-300" variants={itemVariants} whileHover={{
          y: -2
        }}>
