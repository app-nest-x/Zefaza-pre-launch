...
const AnimatedQuote = ({
  ...
  return <motion.p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6" initial="hidden" animate="visible" variants={{
    visible: {
      transition: {
        staggerChildren: 0.1,
        delayChildren: delay
...
const FloatingElements = () => {
  return <div className="absolute inset-0 overflow-hidden pointer-events-none">
      {[...Array(6)].map((_, i) => <motion.div key={i} className="absolute w-4 h-4 bg-gray-200 rounded-full opacity-20" animate={{
      x: [0, 100, 0],
      y: [0, -100, 0],
      scale: [1, 1.5, 1]
    }} transition={{
...
export default function TestimonialSection() {
  ...
  return <motion.section className="py-24 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden" initial={{
    opacity: 0
  }} whileInView={{
    opacity: 1
  }} transition={{
    ...
    once: true
      ...
      once: true
        ...
        <motion.h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-6 tracking-tight" initial={{
        opacity: 0,
        scale: 0.9
      }} whileInView={{
        opacity: 1,
      ...
      <div className="max-w-4xl mx-auto px-6 relative">
          ...
          <AnimatePresence mode="wait" custom={direction}>
            ...
            rotateY: {
              ...
              <Card className={`h-full ${currentTestimonial.bgColor} border-2 border-gray-100 shadow-2xl relative overflow-hidden`}>
                ...
                {}
                <motion.div className="absolute top-6 left-6" animate={{
                rotate: [0, 5, -5, 0],
                scale: [1, 1.1, 1]
              }} transition={{
                duration: 4,
                ...
                <CardContent className="p-8 h-full flex flex-col justify-center relative z-10">
                  ...
                  delay: 1.5
                    ...
                    <div>
                      <motion.h4 className="font-semibold text-lg text-gray-900" initial={{
                      opacity: 0,
                      x: -20
                    }} animate={{
                      opacity: 1,
        ...
        <div className="flex justify-center items-center mt-8 space-x-4">
          ...
          scale: 0.9
            ...
            <Button variant="outline" size="icon" onClick={prevTestimonial} className="rounded-full bg-white border-gray-200 hover:bg-gray-50 shadow-md">
          ...
          <div className="flex space-x-2">
            {testimonials.map((_, index) => <motion.button key={index} className={`w-3 h-3 rounded-full transition-all duration-300 ${index === currentIndex ? `bg-gradient-to-r ${currentTestimonial.color}` : "bg-gray-300"}`} onClick={() => {
          ...
          scale: 0.9
            ...
            <Button variant="outline" size="icon" onClick={nextTestimonial} className="rounded-full bg-white border-gray-200 hover:bg-gray-50 shadow-md">
        ...
        delay: 3
          ...
          <button onClick={() => setIsAutoPlaying(!isAutoPlaying)} className="text-sm text-gray-500 hover:text-gray-700 transition-colors">
      ...
      {}
      <motion.div className="absolute -top-24 -left-24 w-48 h-48 bg-purple-200 rounded-full opacity-20 blur-3xl" animate={{
      scale: [1, 1.2, 1],
      opacity: [0.2, 0.3, 0.2]
    }} transition={{
      duration: 8,
      ...
      <motion.div className="absolute -bottom-24 -right-24 w-64 h-64 bg-blue-200 rounded-full opacity-20 blur-3xl" animate={{
      scale: [1.2, 1, 1.2],
      opacity: [0.3, 0.2, 0.3]
    }} transition={{
      duration: 10,
